...
<body>
    ...
    街区活动
                    ...
                    <a href="#" class="list-group-item">街区活动</a>
                </div>
            </div>
            <div class="col-md-9">
       ...
       <?php
           ...
           select id,img,title,regdate,content
              from active limit $start,$dataNum;
           ";
        ...
        ?>
             ...
             <tr>
                ...
                echo "<li><a href='huodong.php?pageNum=1'>1</a></li>";
                for($i=2;$i<=$pageNums;$i++){
                  echo "<li><a href='huodong.php?pageNum=".$i."'>".$i."</a></li>";
                }
