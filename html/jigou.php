...
<body>
    ...
    入驻机构
                    ...
                    <a href="#" class="list-group-item">入驻机构</a>
                </div>
            </div>
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="row">
                                <div class="col-md-2 ">
                                    <img src="images/55adb1f0922cf.jpg" alt="" class="circle">
                                </div>
    ...
    <?php
           ...
           select id,img,title,regdate,content
              from jigou limit $start,$dataNum;
           ";
                ...
                echo "           
                     ...
                     <tr>
                        <td>
                            ...
                            <div class=\"row\">
                                <div class=\"col-md-2 \">
                                    <img src=\"../admin/template/$filePath\"  class=\"circle\">
                                </div>
                                <div class=\"col-md-10 content2 \">
                                    <p>$content </p>
                                    <p>$regtime
        ...
        ?>
                ...
                echo "<li><a href='jigou.php?pageNum=1'>1</a></li>";
                for($i=2;$i<=$pageNums;$i++){
                  echo "<li><a href='jigou.php?pageNum=".$i."'>".$i."</a></li>";
                }
...
function firstPage(){//跳转到首页
  window.location.href="jigou.php?pageNum=1";
}
function prevPage(p){//跳转到上一页
  if(p>1){
    p=p-1;
  }
  window.location.href="jigou.php?pageNum="+p;
}
